...
- [ ] Task 1.3: Full-page baseline screenshot scrape across Greek (/el/), English (/en/welcome), and Arabic (/ar/مرحبا) live pages with scroll load delay into `ai-work/baselines/` (Mandatory Human Pause Checkpoint) <!-- id: 1.3 -->
