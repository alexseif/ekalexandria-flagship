...
- [x] Task 2: Implement BeTheme Scoping Script (`bin/scope-betheme-config.php`) <!-- id: 3 -->
  - [x] Query BeTheme options (`betheme` / `mfn_theme_options`) <!-- id: 4 -->
  - [x] Extract header settings, logo URLs/dimensions, colors, and typography tokens <!-- id: 5 -->
