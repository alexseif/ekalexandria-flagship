...
- [ ] Task 2.5: Remediate residual shortcodes (Implemented in `inc/cli-commands.php` `wp eka remediate-shortcodes`) and add navigation menu location assignments (Greek Main: 13, English Main: 3315, Arabic Main: 3316, Greek Footer: 21) in `bin/run-phase2-migration.sh`
